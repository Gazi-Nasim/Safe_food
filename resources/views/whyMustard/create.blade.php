...
<div class="card card-default">
    ...
    <div class="card-body">
        <form action="{{route('mustard.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <table role="presentation" class="table table-sm table-striped table-bordered m-0">
                    ...
                    <tbody class="dives">
                        <tr>
                            <td>
                                <div class="">
                                    <input type="file" name="icon[]" class="form-control" required id="icon" value="" autofocus>
                                    @error('icon1')
                            ...
                            <td>
                                <div class="">
                                    <textarea name="details[]" class="form-control" id="details" autofocus="" maxlength="100" cols="30" rows="1" required ></textarea>
                                    @error('details1')
                                    <span style="color: red">{{ $message }}</span>
                                    @enderror
                                </div>
