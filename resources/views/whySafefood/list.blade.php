...
<div class="card card-default">
    ...
    <div class="card-body">
        <div class="form-row table-hover table-responsive">
            <table role="presentation" class="table table-sm table-striped table-bordered m-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">{{$dta->details}}</td>
                        <td class="text-center">
                            <form action="{{route('safe_food.destroy',$dta->id)}}" method="POST">
                                @method('Delete')
                                @csrf
...
<script>
    $(document).on("click", ".remove", function() {
        var mustar_id = $(this).attr('mustar_id');

        console.log(mustar_id);
    });
</script>