                ...
                <table role="presentation" class="table table-sm table-striped table-bordered m-0">
                    ...
                    <tbody class="dives">
                        <tr>
                            <td>
                                <div class="">
                                    <input type="text" name="heading[]" class="form-control" required id="heading" value="" autofocus>
                                    @error('heading')
                            ...
                            <td>
                                <div class="">
                                    <textarea name="details[]" class="form-control" id="details" autofocus="" maxlength="" cols="30" rows="1" required value=""></textarea>
                                    @error('details')
                                    <span style="color: red">{{ $message }}</span>
                                    @enderror
                                </div>
